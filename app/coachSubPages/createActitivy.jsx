...
function createActivity() {
  ...
  useEffect(() => {
    ...
    setForm(prevForm => ({ ...prevForm, time: formattedCurrentTime }));
  }, []);
  ...
  const submit = async () => {
    ...
    const request = {
      method: 'post',
      url: `${connection.serverURL}/activity/create`,
      data: {
  ...
  return (
    <>
      ...
      <CustomLayout title="Create Activity" hasBack={true}>
      ...
      <CustomFormField
        ...
        <CustomBinaryRadio
          ...
          otherStyles="mb-8"
        />
        <CustomTimePicker setParentTime={setSelectedTime} />
